...
public class Dom4JTest {
    public static void main(String[] args) {
        ...
        try {
            document = reader.read(new File("/Users/johnson/job-workspace/prada/pradar-splits/pressure-engine/plugins/jmeter/src/main/resources/test.xml"));
        } catch (Exception e) {
         ...
         * 写入最终压测文件
         */
        File file = FileUtils.createFilePreDelete("/Users/johnson/job-workspace/prada/pradar-splits/pressure-engine/plugins/jmeter/src/main/resources/test-modi.xml");
